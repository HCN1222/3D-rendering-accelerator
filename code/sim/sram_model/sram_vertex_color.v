...
module sram_vertex_color #(     //for activation
parameter CH_NUM = 1,
...
input [CH_NUM*ACT_PER_ADDR*BW_PER_ACT-1:0] wdata, //write data 24 bits
input [19:0] waddr, //write address
input [19:0] raddr, //read address

output reg [CH_NUM*ACT_PER_ADDR*BW_PER_ACT-1:0] rdata //read data 24 bits
);
