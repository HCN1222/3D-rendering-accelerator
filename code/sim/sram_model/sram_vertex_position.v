...
module sram_vertex_position #(     //for activation
parameter CH_NUM = 1,
parameter ACT_PER_ADDR = 1,
parameter BW_PER_ACT = 72
)
(
input clk,
input csb,  //chip enable
input wsb,  //write enable
input [CH_NUM*ACT_PER_ADDR*BW_PER_ACT-1:0] wdata, //write data 72 (3*24) bits
input [19:0] waddr, //write address
input [19:0] raddr, //read address

output reg [CH_NUM*ACT_PER_ADDR*BW_PER_ACT-1:0] rdata //read data 72 (3*24) bits
);
