...
(
  ...
  output [15:0] read_address_sram_CD,                    // address for Color and Weight SRAM
  output [15:0] write_address_sram_CD,                    // address for Color and Weight SRAM
...
wire get_next_triangle;
	...
	// to top
	.read_address_sram_CD(read_address_sram_CD),
